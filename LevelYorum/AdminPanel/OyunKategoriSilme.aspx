<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="OyunKategoriSilme.aspx.cs" Inherits="LevelYorum.AdminPanel.OyunKategoriSilme" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h3 style="margin: 30px 270px 0 0">Oyun Kategori Silme</h3>
        <div>
            <div>
                <asp:Panel ID="pnl_basarili" runat="server" CssClass="basarili" Visible="false">
                    Oyun Kategori Silme Başarılı
                </asp:Panel>
            ...
            <div style="float: left; margin: 50px 0 0 250px">
                ...
                <div style="text-align: center; width: 50%; margin: 50px 0 0 120px">
                    <asp:LinkButton ID="lbtn_sil" Text="Oyun Kategori Sil" runat="server" CssClass="ekleButon" OnClick="lbtn_sil_Click"></asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
