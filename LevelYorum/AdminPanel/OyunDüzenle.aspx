<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="OyunDüzenle.aspx.cs" Inherits="LevelYorum.AdminPanel.OyunDüzenle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h3 style="margin: 30px 270px 0 0">Oyun Düzenle</h3>
        <div>
            <div>
                <asp:Panel ID="pnl_basarili" runat="server" CssClass="basarili" Visible="false">
                    Oyun Düzenleme Başarılı
                </asp:Panel>
            ...
            <div style="text-align: center; width: 50%; margin: 100px 0 0 165px">
                <asp:LinkButton ID="lbtn_ekle" Text="Oyun Düzenle" runat="server" CssClass="ekleButon" OnClick="lbtn_ekle_Click"></asp:LinkButton>
            </div>
        </div>
    </div>
</asp:Content>
