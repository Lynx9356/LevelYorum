<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="KullaniciEkle.aspx.cs" Inherits="LevelYorum.AdminPanel.KullaniciEkle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h3 style="margin: 30px 270px 0 0">Kullanıcı Ekle</h3>
        <div>
            <div>
            ...
            <div style="text-align: center; width: 50%; margin: 15px 0 0 165px">
                <asp:LinkButton ID="lbtn_ekle" Text="Kullanıcı Ekle" runat="server" CssClass="ekleButon" OnClick="lbtn_ekle_Click"></asp:LinkButton>
            </div>
        </div>
    </div>
</asp:Content>
